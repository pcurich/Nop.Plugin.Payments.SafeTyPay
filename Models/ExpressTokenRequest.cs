...
namespace Nop.Plugin.Payments.SafeTyPay.Models
{
    public class ExpressTokenRequest
    {
        ...
        public string ApiKey { get; set; } = null!;//bc8882c4f6540769b33f809bcb98a839
        ...
        public string CurrencyCode { get; set; } = null!;//USD, EUR, MXN, etc.
        ...
        public string MerchantSalesID { get; set; } = null!;//ORD-10001,RXW-P03-V01,001-012312220, etc

        //String (Required, ISO 639-1 Example: EN, ES, PT, DE, etc.) Specifies the language for the Express Application
        public string Language { get; set; } = null!;//EN, ES, PT, DE, etc.

        //Only for PSPs: Field used to send Submerchant ID (Optional)
        public string TrackingCode { get; set; } = null!; //TX-0001 Merchant - 01
        ...
        public string TransactionOkURL { get; set; } = null!;//https://www.website.com/thanks

        //String(Required) URL where shopper will be redirected from the online banking if payment was wrong.(Must be Https)
        public string TransactionErrorURL { get; set; } = null!;//https://flippingbook.com/404

        //String Only for PSPs
        public string CustomMerchantName { get; set; } = null!;//Avianca Taca, Adidas, etc

        //String (Optional) Contains the shopper's email
        public string ShopperEmail { get; set; } = null!;//example@safetypay.com
        ...
        //String(Optional) Contains the shopper's email
        public string ShopperInformation_email { get; set; } = null!;// example@safetypay.com

        //String (Optional) Contains the shopper's first name
        public string ShopperInformation_first_name { get; set; } = null!;//Pedro

        //String (Optional) Contains the shopper's last name
        public string ShopperInformation_last_name { get; set; } = null!;//Curich

        //String(Optional) contains the shopper's country code
        public string ShopperInformation_country_code { get; set; } = null!;//+51

        //String(Optional)Contains the shopper's mobile numbe
        public string ShopperInformation_mobile { get; set; } = null!; //987654321
