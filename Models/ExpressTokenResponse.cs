namespace Nop.Plugin.Payments.SafeTyPay.Models
{
    public class ExpressTokenResponse
    {
        ...
        public string ClientRedirectURL { get; set; } = null!;//https://sandbox-gateway.safetypay.com/Express4/Checkout/index?TokenID=86b7eba7-0965-4410-abf3-4a27e4929ffc

        //String Refer to https://developers.safetypay.com/docs/generating-signature
        public string Signature { get; set; } = null!;//Hash SHA256: ResponseDateTime +ClientRedirectURL +SignatureKey
