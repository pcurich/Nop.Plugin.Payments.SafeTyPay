...
namespace Nop.Plugin.Payments.SafeTyPay.Models
{
    public class NotificationRequest
    {
        ...
        public string MerchantSalesID { get; set; } = null!; //001-012312220, etc.
        ...
        public string CurrencyId { get; set; } = null!;// USD, EUR, MXN, etc.

        //String(max-lenght = 20) Reference number of the payment operation
        public string PaymentReferenceNo { get; set; } = null!;//871972462221

        //StatusType Status of SafetyPay operation
        public string StatusCode { get; set; } = null!; //“102”, “201”, etc

        public string Signature { get; set; } = null!;//Hash SHA256 :
                                                      //RequestDateTime
                                                      //+MerchantSalesID
                                                      //+ReferenceNo
                                                      //+CreationDateTime
        ...
        public bool IsValid(string signatureKey)
        {
            ...
            return Signature.ToUpper() == signature.ToUpper();
        }
    }
}